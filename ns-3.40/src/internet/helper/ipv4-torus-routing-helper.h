...
#ifndef IPV4_TORUS_ROUTING_HELPER_H
#define IPV4_TORUS_ROUTING_HELPER_H

#include "ipv4-routing-helper.h"

#include "ns3/ipv4-address.h"
#include "ns3/ipv4-torus-routing.h"
#include "ns3/ipv4.h"
 ...
 * \ingroup ipv4Helpers
 *
 * \brief Helper class that adds ns3::Ipv4TorusRouting objects
 *
 * This class is expected to be used in conjunction with
 * ns3::InternetStackHelper::SetRoutingHelper
 */
class Ipv4TorusRoutingHelper : public Ipv4RoutingHelper {
public:
  /*
   * Construct an Ipv4TorusRoutingHelper object, used to make configuration
   * of Torus routing easier.
   */
  Ipv4TorusRoutingHelper();

  /**
   * \brief Construct an Ipv4TorusRoutingHelper from another previously
   * initialized instance (Copy Constructor).
   * \param o object to be copied
   */
  Ipv4TorusRoutingHelper(const Ipv4TorusRoutingHelper &o);

  // Delete assignment operator to avoid misuse
  Ipv4TorusRoutingHelper &operator=(const Ipv4TorusRoutingHelper &) = delete;

  /**
   * \returns pointer to clone of this Ipv4TorusRoutingHelper
   *
   * This method is mainly for internal use by the other helpers;
   * clients are expected to free the dynamic memory allocated by this method
   */
  Ipv4TorusRoutingHelper *Copy() const override;
  ...
  /**
   * Try and find the Torus routing protocol as either the main routing
   * protocol or in the list of routing protocols associated with the
   * Ipv4 provided.
   *
   * \param ipv4 the Ptr<Ipv4> to search for the Torus routing protocol
   * \returns Ipv4TorusRouting pointer or 0 if not found
   */
  Ptr<Ipv4TorusRouting> GetTorusRouting(Ptr<Ipv4> ipv4) const;
   ...
   * name string previously associated to the device using the Object Name
   * Service.
   *
   * \param n The node.
   * \param source Source address.
  ...
  /**
   * \brief Add a default route to the Torus routing protocol to forward
...
#endif /* IPV4_TORUS_ROUTING_HELPER_H */
